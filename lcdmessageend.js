...
// String to display
var my_string = "5 sec before program restart";
...
function LCD_init(callback) {
    ...
    var steps = [
        ...
        function(){ write_string_to_lcd('End of program', next ); },
        function(){ setTimeout(next, 1800); },
        function(){ write_string_to_lcd('Program set to loop infinitely ', next ); },
        function(){ setTimeout(next, 2000); },
        function(){ write_string_to_lcd('To escape in cmd line          ', next ); },
        function(){ setTimeout(next, 1800); },
        function(){ write_string_to_lcd('ctrl + c                ', next ); },
        function(){ setTimeout(next, 1800); },
        function(){ write_string_to_lcd('Otherwise power down the board ', next ); },
        function(){ setTimeout(next, 1800); },
