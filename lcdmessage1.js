...
// String to display
var my_string = "Modechange? Current:Fall detect";
...
function LCD_init(callback) {
    ...
    var steps = [
        ...
        function(){ setTimeout(next, 1000); },
        function(){ write_string_to_lcd('PB18 Sentinel Monitoring', next ); },
        function(){ setTimeout(next, 1800); },
        function(){ write_string_to_lcd('BLE Cape proto3         ', next ); },
        function(){ setTimeout(next, 1800); },
        function(){ write_string_to_lcd('To change mode    ', next ); },
        function(){ setTimeout(next, 1200); },
        function(){ write_string_to_lcd('Press the button   ', next ); },
        function(){ setTimeout(next, 1200); },
        function(){ write_string_to_lcd('When LED light up  ', next ); },
        function(){ setTimeout(next, 1200); },
