...
function LCD_init(callback) {
    ...
    var steps = [
        ...
        function(){ write_string_to_lcd('\x7eEntering...', next ); },
        function(){ setTimeout(next, 1000); },
        function(){ write_string_to_lcd('Vital sign mode', next ); },
        function(){ setTimeout(next, 2500); },
